...
extern int I2C_GetSlvRxCount(int ch);
extern int I2C_GetSlvRxData(int ch);
extern void I2C_SetSlvRxData(int ch, int data);
extern int I2C_GetSlvTxCount(int ch);
extern int I2C_GetSlvTxData(int ch);
extern void I2C_SetSlvTxData(int ch, int data);
