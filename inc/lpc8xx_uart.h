...
extern int UART_GetRxCount(int ch);
extern int UART_GetRxData(int ch);
extern void UART_SetRxData(int ch, int data);
extern int UART_GetTxCount(int ch);
extern int UART_GetTxData(int ch);
extern void UART_SetTxData(int ch, int data);
