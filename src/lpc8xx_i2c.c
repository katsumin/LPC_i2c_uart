...
//volatile uint32_t I2CSlvRXReadPointer = 0;
//volatile uint32_t I2CSlvRXWritePointer = 0;
//volatile uint32_t I2CSlvTXCount = 0;
//volatile uint32_t I2CSlvTXReadPointer = 0;
//volatile uint32_t I2CSlvTXWritePointer = 0;
...
//				slvrxrdy = 1;
				// ch=0の場合、I2Cポートから取得したデータを、I2Cコマンド受信バッファから書き込む
				// ch=1の場合、I2Cポートから取得したデータを、I2C受信バッファから書き込む
